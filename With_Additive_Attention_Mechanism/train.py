...
x_test = data['x_test']
y_test = data['y_test']
print(f"✓ Data loaded: {x_train.shape[0]} training samples, {x_test.shape[0]} test samples", flush=True)
...
print("✓ Training complete! Files saved: telugu_model.h5 and training_history.pkl", flush=True)